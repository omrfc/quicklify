...
- **Content:** Server provisioning, hardening and audit MCP server with 13 tools. 448-check security audit, 24-step hardening, CIS/PCI-DSS/HIPAA compliance. npm: `npx kastell-mcp`. GitHub: https://github.com/kastelldev/kastell
