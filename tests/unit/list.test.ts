...
describe('listCommand', () => {
  ...
  it('should display multiple servers', async () => {
    mockedConfig.getServers.mockReturnValue([
      { id: '1', name: 'srv-a', provider: 'hetzner', ip: '1.1.1.1', region: 'nbg1', size: 'cax11', createdAt: '2026-01-01T00:00:00Z' },
      { id: '2', name: 'srv-b', provider: 'digitalocean', ip: '2.2.2.2', region: 'nyc1', size: 's-2vcpu-2gb', createdAt: '2026-02-01T00:00:00Z' },
    ]);
  ...
  it('should handle missing createdAt gracefully', async () => {
    mockedConfig.getServers.mockReturnValue([
      { id: '1', name: 'srv', provider: 'hetzner', ip: '1.1.1.1', region: 'nbg1', size: 'cax11', createdAt: '' },
    ]);
